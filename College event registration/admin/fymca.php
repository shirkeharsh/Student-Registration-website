...
if($_SERVER['REQUEST_METHOD'] === 'GET' && isset($_GET['reset'])){
    mysqli_query($conn, "UPDATE user SET status = NULL WHERE course = 'FY MCA'");
}
...
$select_fymca_attended = mysqli_query($conn, "SELECT * FROM user WHERE course = 'FY MCA' AND status = 'approved';") or die('query failed');
$fymca_attended = mysqli_num_rows($select_fymca_attended);
    ...
    <div class="container py-5">
        <div class="row justify-content-center mb-5">
            <div class="col-12 text-center">
                <h1 class="display-4 animate__animated animate__fadeIn">FYMCA</h1>
            </div>
        </div>
            ...
            <div class="d-flex flex-lg-row flex-column justify-content-center align-items-center">
                ...
                <div class="card m-3 shadow-lg animate__animated animate__fadeInUp animate__delay-1s" style="width: 12rem; height: 8rem;">
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            <?php echo $fymca_attended; ?>
                        </p>
                    </div>
                </div>
            </div>

            <h2 class="animate__animated animate__fadeInUp animate__delay-2s">FY MCA - Registrations</h2>
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover" id="fytable">
                            ...
                            <tbody>
                                <?php
                                $select_users = mysqli_query($conn, "SELECT * FROM user WHERE course = 'FY MCA' ORDER BY uid ASC") or die('query failed');
